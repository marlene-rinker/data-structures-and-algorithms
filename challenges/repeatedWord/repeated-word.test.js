...
const findFirstRepeatedWord = require('./repeated-word.js');

describe('Testing find first repeated word', () => {
  it ('should return the first repeated word from a string', () => {
    ...
    expect(findFirstRepeatedWord(myString)).toEqual('a');
    expect(findFirstRepeatedWord(myString2)).toEqual('it');
    expect(findFirstRepeatedWord(myString3)).toEqual('summer');
    expect(findFirstRepeatedWord(myString4)).toEqual('No repeated words');
  })
});  